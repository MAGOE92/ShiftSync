...
export default function SetupView() {
  const {
    T, crd, inp, lbl, btn,
    wiz, setWiz, doSetup, setView, isSuper,
    Logo, Tst, DarkBtn,
  } = useApp();
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, display: "flex", alignItems: "center", justifyContent: "center", padding: 20, color: T.tx }}>
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={crd}>
          <h2 style={{ margin: "0 0 4px", fontSize: 18, fontWeight: 800 }}>Betrieb einrichten</h2>
          <p style={{ margin: "0 0 18px", fontSize: 12, color: T.tx2 }}>14 Tage kostenlos testen — keine Kreditkarte nötig.</p>
          ...
          <button style={{ ...btn("p"), width: "100%", marginTop: 18 }} onClick={doSetup}>
            <Icon n="sparkle" s={15} />14 Tage kostenlos starten
          </button>
        </div>
